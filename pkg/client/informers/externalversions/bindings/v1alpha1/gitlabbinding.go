...
import (
	...
	bindingsv1alpha1 "knative.dev/eventing-gitlab/pkg/apis/bindings/v1alpha1"
	versioned "knative.dev/eventing-gitlab/pkg/client/clientset/versioned"
	internalinterfaces "knative.dev/eventing-gitlab/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "knative.dev/eventing-gitlab/pkg/client/listers/bindings/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BindingsV1alpha1().GitLabBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BindingsV1alpha1().GitLabBindings(namespace).Watch(context.TODO(), options)
			},
		},
