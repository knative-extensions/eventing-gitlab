...
import (
	...
	versionedscheme "knative.dev/eventing-gitlab/pkg/client/clientset/versioned/scheme"
	client "knative.dev/eventing-gitlab/pkg/client/injection/client"
	gitlabsource "knative.dev/eventing-gitlab/pkg/client/injection/informers/sources/v1alpha1/gitlabsource"
...
const (
	defaultControllerAgentName = "gitlabsource-controller"
	defaultFinalizerName       = "gitlabsources.sources.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	gitlabsourceInformer := gitlabsource.Get(ctx)

	lister := gitlabsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.knative.dev.GitLabSource"),
	)
