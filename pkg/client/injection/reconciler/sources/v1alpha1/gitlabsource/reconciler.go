...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GitLabSource, desiredFinalizers sets.String) (*v1alpha1.GitLabSource, error) {
	// Don't modify the informers copy.
