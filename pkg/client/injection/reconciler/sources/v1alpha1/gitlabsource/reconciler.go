...
// controller finalizing v1alpha1.GitLabSource if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1alpha1.GitLabSource.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1alpha1.GitLabSource) reconciler.Event
}
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.GitLabSource, desired *v1alpha1.GitLabSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GitLabSource) (*v1alpha1.GitLabSource, error) {

	getter := r.Lister.GitLabSources(resource.Namespace)
