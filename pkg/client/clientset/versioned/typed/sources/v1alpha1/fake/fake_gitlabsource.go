...
var gitlabsourcesResource = v1alpha1.SchemeGroupVersion.WithResource("gitlabsources")

var gitlabsourcesKind = v1alpha1.SchemeGroupVersion.WithKind("GitLabSource")
