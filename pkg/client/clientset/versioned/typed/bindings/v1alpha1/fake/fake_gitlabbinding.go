...
// FakeGitLabBindings implements GitLabBindingInterface
type FakeGitLabBindings struct {
...
func (c *FakeGitLabBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GitLabBinding, err error) {
	...
	return obj.(*v1alpha1.GitLabBinding), err
}
...
func (c *FakeGitLabBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GitLabBindingList, err error) {
	...
	list := &v1alpha1.GitLabBindingList{ListMeta: obj.(*v1alpha1.GitLabBindingList).ListMeta}
	for _, item := range obj.(*v1alpha1.GitLabBindingList).Items {
